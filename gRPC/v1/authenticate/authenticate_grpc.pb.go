...
type AuthenticateServiceClient interface {
	Authenticate(ctx context.Context, in *AuthenticateRequest, opts ...grpc.CallOption) (*AuthenticatePayload, error)
}
...
func (c *authenticateServiceClient) Authenticate(ctx context.Context, in *AuthenticateRequest, opts ...grpc.CallOption) (*AuthenticatePayload, error) {
	out := new(AuthenticatePayload)
	err := c.cc.Invoke(ctx, "/authenticate.AuthenticateService/Authenticate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthenticateServiceServer interface {
	Authenticate(context.Context, *AuthenticateRequest) (*AuthenticatePayload, error)
...
func (UnimplementedAuthenticateServiceServer) Authenticate(context.Context, *AuthenticateRequest) (*AuthenticatePayload, error) {
...
func _AuthenticateService_Authenticate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/authenticate.AuthenticateService/Authenticate",
	}
...
var AuthenticateService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "gRPC/v1/authenticate/authenticate.proto",
}
